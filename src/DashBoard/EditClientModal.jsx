...
export default function EditClientModal({ client, onClose, onUpdate, avatars }) {
  ...
  const handleSubmit = () => {
    ...
    if (!form.selectedAvatarId || form.avatars.length === 0) {
      alert("Please assign an avatar");
      return;
    }
    onUpdate(client.clientId, form);
  };
      ...
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-2xl max-h-[calc(100vh-160px)] flex flex-col relative">
        ...
        <div className="px-8 pt-8 pb-4 border-b">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Update client background and therapy context
          </p>
        </div>
